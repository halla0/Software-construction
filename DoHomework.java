...
public class DoHomework{
	 ...
	 */
	//为选择之前做过的题目使用
	public static String For_Select_Finish_Remain[] = new String[50];
	//刚开始显示在屏幕上的文字
	public void First_Greet(){
		...
		if( temp == 1){
			new DoHomework().Finish_Remain();
		}
		else{
			new DoHomework().Random_Exercise();
		}
	}
	...
	public static void main(String[] args) {
		DoHomework test = new DoHomework();
		test.First_Greet();
	}
}